(function($) {
    ...
    function OrgChart($container, opts){
        ...
        this.startEdit = function(id){
            var inputElement = $('<textarea class="org-input" type="text" value="'+nodes[id].data.name+'">"'+nodes[id].data.title+'"</textarea>');
            $container.find('div[node-id='+id+'] h2').replaceWith(inputElement);
            var commitChange = function(){
                var h2Element = $('<h2>'+nodes[id].data.name+'</h2>');style="font-weight: 500 !important;font-size: small !important;"
                if(opts.allowEdit){
        ...
        //////////////////////title field//////////////////////////////
            ...
            var inputElement = $('<textarea class="org-input" type="text" value="'+nodes[id].data.title+'">"'+nodes[id].data.title+'"</textarea>');
